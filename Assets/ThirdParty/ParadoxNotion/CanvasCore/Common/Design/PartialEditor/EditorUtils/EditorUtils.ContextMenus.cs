...
namespace ParadoxNotion.Design
{
	...
	partial class EditorUtils
    {
        ...
        public static MenuItemInfo[] GetMenuItems(GenericMenu menu) {
            ...
            Type menuType = typeof(GenericMenu);
            var bindingFlags = BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static;
            PropertyInfo propertyInfo = menuType.GetProperty("menuItems", bindingFlags);
            var allItems = propertyInfo.GetValue(menu);
            var items = allItems as ICollection;
